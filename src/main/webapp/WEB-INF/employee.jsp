...
<body>
	<div id="toolbar">
		...
		<a onclick="open_upd()" href="#" class="easyui-linkbutton" iconCls="icon-edit" aria-disabled="false">修改</a>
		<a onclick="batchDel();" href="#" class="easyui-linkbutton" iconCls="icon-remove">删除</a>
	</div>
	<table id="grid" aria-rowcount=""></table>
...
function grid() {
   ...
   // console.log(curr);
	...
	$("#grid").datagrid({url: "gridByName", queryParams: {name: $("#queryName").val(),rows:$("")}, pageNumber: 1});
/*	$.get(
			"gridByName",$("#queryName").val(),function (){
